...
; Display message "Enter an lowercase letter: "
...
; Check if the character is an lowercase letter (A-Z)
...
SUB AL, 20h        ; Add 32 (20h) to convert lowercase to uppercase
mov bl,al
...
MOV DL, BL         ; Move the uppercase letter to DL
...
NotLowerCase:
; If the input is not an lowercase letter, display an error message
